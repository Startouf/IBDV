...
/** Should have used a function like this to remove stuff ****/
function deleteSVG(){
...
function showBarChart() {
	...
	d3.selectAll("#titleScatterplot").style("display", "none");	
	d3.selectAll("#titleScatterplot2").style("display", "none");				
